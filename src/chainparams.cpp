...
void CChainParams::UpdateAIP3Parameters(int nActivationHeight, int nEnforcementHeight)
{
    consensus.AIP0003Height = nActivationHeight;
    consensus.AIP0003EnforcementHeight = nEnforcementHeight;
}
...
std::unique_ptr<CChainParams> CreateChainParams(const std::string& chain)
{
    if (chain == CBaseChainParams::MAIN)
        ...
        return std::unique_ptr<CChainParams>(new CPoVNetParams());
...
void UpdateAIP3Parameters(int nActivationHeight, int nEnforcementHeight)
{
    globalChainParams->UpdateAIP3Parameters(nActivationHeight, nEnforcementHeight);
}
